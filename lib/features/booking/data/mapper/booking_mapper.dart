...
class BookingMapper
    implements BaseMapper<BookingEntity, BookingModel> {
  const BookingMapper();

  static const CustomerMapper _customerMapper =
  CustomerMapper();
  ...
  BookingEntity toEntity(BookingModel model) {
    return BookingEntity(
      ...
      customer: _customerMapper.fromJson(
        model.customer,
      ),
      package: _packageFromJson(
        model.package,
      ),
      payment: _paymentFromJson(
        model.payment,
      ),
      leadSource: LeadSource.values.byName(
        model.leadSource,
      ),
  ...
  BookingModel toModel(BookingEntity entity) {
    return BookingModel(
      ...
      customer: _customerMapper.toJson(
        entity.customer,
      ),
      package: _packageToJson(
        entity.package,
      ),
      payment: _paymentToJson(
        entity.payment,
      ),
  ...
  static PackageEntity _packageFromJson(
    ...
    return PackageEntity(
      ...
      destinationCountry:
      json['destinationCountry'] as String,
  ...
  static Map<String, dynamic> _packageToJson(
    ...
    return {
      ...
      'departureDate':
      entity.departureDate.toIso8601String(),
      'returnDate':
      entity.returnDate.toIso8601String(),
      'price': entity.price,
  ...
  static PaymentEntity _paymentFromJson(
      Map<String, dynamic> json,
      ) {
  ...
  static Map<String, dynamic> _paymentToJson(
    ...
    return {
      ...
      'dueDate':
      entity.dueDate?.toIso8601String(),
      'paidAt':
      entity.paidAt?.toIso8601String(),
      'notes': entity.notes,
      'isActive': entity.isActive,
      'createdAt':
      entity.createdAt.toIso8601String(),
